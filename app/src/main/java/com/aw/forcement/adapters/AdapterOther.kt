 ...
 */
class AdapterOther(private val context: Context, mList: List<FeesAndCharges>) :
	RecyclerView.Adapter<AdapterOther.ViewHolder?>() {
	private var mList: List<FeesAndCharges> = ArrayList<FeesAndCharges>()
