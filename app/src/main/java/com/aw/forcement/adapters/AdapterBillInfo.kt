 ...
 */
class AdapterBillInfo(private val context: Context, mList: List<BillInfo>) :
	RecyclerView.Adapter<AdapterBillInfo.ViewHolder?>() {
	private var mList: List<BillInfo> = ArrayList<BillInfo>()
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
		val view: View = LayoutInflater.from(parent.context)
			.inflate(R.layout.item_feeandcharge, parent, false)
		return ViewHolder(view)
	}

	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		val list: BillInfo = mList[position]
		...
		holder.tv_amount.text = "KES ${list.billTotal}"
