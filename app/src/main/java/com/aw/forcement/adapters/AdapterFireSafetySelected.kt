 ...
 */
class AdapterFireSafetySelected(private val context: Context, mList: List<String>) :
	RecyclerView.Adapter<AdapterFireSafetySelected.ViewHolder?>() {
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		val list: String = mList[position]

		holder.checkbox.text =list
