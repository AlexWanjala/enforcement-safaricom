 ...
 */
class AdapterRentPromised(private val context: Context, mList: List<Businesses>) :
	RecyclerView.Adapter<AdapterRentPromised.ViewHolder?>() {
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
		val view: View = LayoutInflater.from(parent.context)
			.inflate(R.layout.item_rent_promised, parent, false)
