 ...
 */
class FireSpAdapter(private val context: Context, mList: List<Businesses>) :
	RecyclerView.Adapter<FireSpAdapter.ViewHolder?>() {
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		...
		holder.layoutView.setOnClickListener {
			context.startActivity(Intent(context,BusinessDetails::class.java).putExtra("businessID",list.businessID))
		}
