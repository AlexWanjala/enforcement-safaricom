 ...
 */
class HygieneSbpAdapter(private val context: Context, mList: List<Businesses>) :
	RecyclerView.Adapter<HygieneSbpAdapter.ViewHolder?>() {
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		...
		holder.layoutView.setOnClickListener {
			context.startActivity(Intent(context,com.aw.forcement.health.hygiene.BusinessDetails::class.java).putExtra("businessID",list.businessID))
		}
