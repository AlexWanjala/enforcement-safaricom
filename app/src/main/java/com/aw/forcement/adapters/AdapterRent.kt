 ...
 */
class AdapterRent(private val context: Context, mList: List<Businesses>) :
	RecyclerView.Adapter<AdapterRent.ViewHolder?>() {
	...
	inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
		...
		var tv_unit_no: TextView = itemView.findViewById<View>(R.id.tv_unit_no) as TextView
		var tv_tenant: TextView = itemView.findViewById<View>(R.id.tv_tenant) as TextView
		var tv_amount: TextView = itemView.findViewById<View>(R.id.tv_amount) as TextView
		var tv_due: TextView = itemView.findViewById<View>(R.id.tv_due) as TextView
