...
class UsersRoAdapter(private val context: Context, mList: List<Users>) :
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		...
		holder.tv_time.text =covertTimeToText(list.lastSeen)

		holder.layoutView.setOnClickListener {
			context.startActivity(Intent(context,com.aw.forcement.history.MyHistory::class.java).putExtra("idNo",list.idNo).putExtra("names",list.names))
		}
