 ...
 */
class SbpAdapterRenew(private val context: Context, mList: List<Businesses>) :
	RecyclerView.Adapter<SbpAdapterRenew.ViewHolder?>() {
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		...
		holder.layoutView.setOnClickListener {
			context.startActivity(Intent(context,com.aw.forcement.sbp.renew.ApplicationsDetail::class.java).putExtra("id",list.id))
		}
